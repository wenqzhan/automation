package com.seleniumModified.utils.asserts;

import com.seleniumModified.utils.date.DateFormat;
...
public class MyAssert {
    final static LoggerController log = LoggerController.getLogger(MyAssert.class);
